      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16 space-y-3">
          ...
          <p className="text-slate-500 text-sm sm:text-base max-w-md mx-auto">
            Setiap foto menyimpan sejuta cerita yang selalu bikin tersenyum.
          </p>
        </div>
          ...
          {CONFIG.memoryGallery.map((photo, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Image Frame */}
                <div className="overflow-hidden rounded-lg bg-slate-100 relative aspect-square sm:aspect-auto">
                  <img
                    src={photo.image}
                    alt={`Memory ${photo.id}`}
                    className={`w-full object-cover transition-transform duration-700 group-hover:scale-110 ${
                      isFeatured ? 'h-72 sm:h-96' : 'h-48 sm:h-60'
                    }`}
                  />
